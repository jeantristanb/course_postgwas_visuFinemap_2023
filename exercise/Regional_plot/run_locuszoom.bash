...
plink -bfile data/chr17_77727734_79727734      --ld-window-kb 10000 --ld-snp  17:78727734:T:C  --ld-window 99999  --ld-window-r2 0 -out data/chr17_77727734_79727734 --r2 
# CHR_A         BP_A             SNP_A  CHR_B         BP_B             SNP_B           R2 
echo -e "snp1\tsnp2\tdprime\trsquare" > data/chr17_77727734_79727734_lz.ld
sed '1d' data/chr17_77727734_79727734.ld | awk '{print "chr"$1":"$2"\tchr"$1":"$5"\tNA\t"$7}' >> data/chr17_77727734_79727734_lz.ld

/dataE/AWIGenGWAS/shared/ResultGWAS/Ressource/locuszoom/bin/locuszoom --build hg19 --epacts  data/data_regplot.epact --chr 17 --start 77727734 --end 79727734 --gwas-cat whole-cat_significant-only --ld data/chr17_77727734_79727734_lz.ld -p gcld  
